...
export default function About() {
  return (
    <div className="px-5 lg:px-28 flex justify-between flex-col lg:flex-row" id="about">
      <motion.div
        className="lg:w-1/2 mr-8 lg:mr-16"
        initial={{ opacity: 0, x: -50 }}
        whileInView={{ opacity: 1, x: 0 }}
        transition={{ type: "spring", stiffness: 50, damping: 10 }}
        viewport={{ once: true }}
      >
        <img src="src\assets\profile-square-11.jpeg" alt="About Me Illustration" />
      </motion.div>
      ...
      >
        ...
        <p className="text-[#71717A] text-sm/6 lg:text-base mt-3 lg:mt-5">
          My web development journey started in **2023**, and since then, I've continuously evolved, taking on new challenges and keeping up with the latest technologies. Today, I build **cutting-edge web applications** using **React.js, Node.js, TypeScript, TailwindCSS and more**.
        </p>
