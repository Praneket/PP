    ...
    <div className="mt-20" id="home">
      <div className="flex justify-between py-10 items-center px-5 lg:px-28 lg:flex-row flex-col-reverse">
        ...
        >
          ...
          >
            {[
                    { Icon: BiLogoGmail, link: "mailto:jadhavpraneket@gmail.com" },
                    { Icon: IoLogoLinkedin, link: "https://www.linkedin.com/in/praneket-jadhav" },
                    { Icon: BsGithub, link: "https://github.com/Praneket" },
                  ].map(({ Icon, link }, index) => (
              <motion.a
                key={index}
                href={link}
